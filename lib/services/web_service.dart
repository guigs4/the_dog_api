...
import 'package:the_dog_app/secrets.dart'; //pseudo 'UserSecrets'
...
class WebService{
  ...
  Future<List<DogImage>> fetchDogImages({int page = 0, String size = "full", String order = "RANDOM", String breedId = ""}) async{
    String url = "https://api.thedogapi.com/v1/images/search";
    dio.options.headers = headers;
    var response = await dio.get(
      url,
      queryParameters: {'page': page, 'size': size, 'order':order, 'limit':100, 'breed_id':breedId}
    );
